  ...
  return <section className="section bg-[#f3efe9] dark:bg-neutral-900">
    <div className="container">
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2">
        <motion.article {...reveal} className="relative min-h-[520px] overflow-hidden rounded-[34px] bg-[#cbc3b8]"><Image src="/images/tomoc-beauty-campaign.png" alt="Арчилгааны өмнөх мэдрэмжийн жишээ" fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover object-[58%_center] grayscale opacity-65"/><div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/5 to-transparent"/><div className="absolute inset-x-0 bottom-0 p-7 text-white md:p-9"><span className="text-[11px] font-bold uppercase tracking-[.22em] text-white/60">Өмнө</span><h3 className="display-serif mt-2 text-4xl">Хуурай, барзгар мэдрэмж</h3><p className="mt-3 max-w-md text-sm leading-6 text-white/65">Чийг дутагдсан үед үс самнахад төвөгтэй, үзүүр хэсгээрээ хуурай мэдрэгдэж болно.</p></div></motion.article>
        <motion.article {...reveal} transition={{...reveal.transition,delay:.08}} className="relative min-h-[520px] overflow-hidden rounded-[34px] bg-[#d8c5aa]"><Image src="/images/tomoc-beauty-campaign.png" alt="Тогтмол арчилгааны дараах мэдрэмжийн жишээ" fill sizes="(max-width:768px) 100vw, 50vw" className="object-cover object-[58%_center]"/><div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent"/><div className="absolute inset-x-0 bottom-0 p-7 text-white md:p-9"><span className="text-[11px] font-bold uppercase tracking-[.22em] text-[#ead5af]">Дараа</span><h3 className="display-serif mt-2 text-4xl">Зөөлөн, гялалзсан харагдац</h3><p className="mt-3 max-w-md text-sm leading-6 text-white/70">Тогтмол тэжээллэг арчилгаа нь үсийг илүү зөөлөн, самнахад эвтэйхэн мэдрүүлэхэд тусална.</p></div></motion.article>
      </div>
